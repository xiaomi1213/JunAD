...
def train_densenet(model, train_loader, device, num_epoch=2, lr=1e-3):
    model.train()
...
if __name__ == "__main__":
    ...
    from MNIST.base_cnn import CNN
    from MNIST.vae_model import VAE
    from MNIST.ae_model import AutoEncoder
    from MNIST.reverse_vae import REVERSE_VAE
    ...
    train_densenet(densenet, train_loader, device, num_epoch=10, lr=1e-3)
    torch.save(densenet, '/home/junhang/Projects/Scripts/saved_model/CIFAR/densetnet.pkl')