...
test_data = torchvision.datasets.ImageFolder(
    root='/home/junhang/Projects/DataSet/IMAGENET/test',
    train=False
)
...
densenet = torch.load('/home/junhang/Projects/Scripts/saved_model/IMAGENET/densenet.pkl').eval()
rev_vae = torch.load('/home/junhang/Projects/Scripts/saved_model/IMAGENET/rev_vae.pkl').eval()
vae_model = torch.load('/home/junhang/Projects/Scripts/saved_model/IMAGENET/vae.pkl').eval()
...
for idx, data in enumerate(list(zip(mix_dataset_x, mix_dataset_y))):
    ...
    if Dkl >= Boundary:
        ...
        test_output = densenet(reversed_samples)
