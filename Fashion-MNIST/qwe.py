...
train_loader = torch.utils.data.DataLoader(
    datasets.CIFAR10('/home/junhang/Projects/DataSet/CIFAR10', train=True, download=True,
                     transform=transforms.ToTensor()),
    batch_size=args.batch_size, shuffle=True, **kwargs)
test_loader = torch.utils.data.DataLoader(
    datasets.CIFAR10('/home/junhang/Projects/DataSet/CIFAR10', train=False, transform=transforms.ToTensor()),
    batch_size=args.batch_size, shuffle=False, **kwargs)

# Cite from https://github.com/wanglouis49/pytorch-autoencoders/blob/master/conv_vae.py
class VAE(nn.Module):
    def __init__(self):
